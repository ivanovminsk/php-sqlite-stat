...
function browserdetect() {
		...
		if (preg_match('/114Browser/i', $useragent)) {
			...
			$title = detect_browser_version("114Browser", $useragent);
			$code = "114browser";
			...
			$title = detect_browser_version("2345Chrome", $useragent);
			$code = "2345chrome";
			...
			$title = "America Online " . detect_browser_version("Browser", $useragent);
			$code = "aol";
		} elseif (preg_match('/AmigaVoyager/i', $useragent)) {
			$link = "http://v3.vapor.com/voyager/";
			$title = "Amiga " . detect_browser_version("Voyager", $useragent);
			$code = "amigavoyager";
		} elseif (preg_match('/AOL/i', $useragent)) {
			$link = "http://downloads.channel.aol.com/browser";
			$title = detect_browser_version("AOL", $useragent);
			$code = "aol";
		} elseif (preg_match('/Arora/i', $useragent)) {
			$link = "http://code.google.com/p/arora/";
			$title = detect_browser_version("Arora", $useragent);
			$code = "arora";
			...
			$title = detect_browser_version("BarcaPro", $useragent);
			$code = "barca";
		} elseif (preg_match('/Barca/i', $useragent)) {
			$link = "http://www.pocosystems.com/home/index.php?option=content&task=category&sectionid=2&id=9&Itemid=27";
			$title = detect_browser_version("Barca", $useragent);
			$code = "barca";
		} elseif (preg_match('/Beamrise/i', $useragent)) {
			$link = "http://www.beamrise.com/";
			$title = detect_browser_version("Beamrise", $useragent);
			$code = "beamrise";
			...
			$title = detect_browser_version("Iris", $useragent);
			$code = "iris";
		} elseif (preg_match('/IBM\ WebExplorer/i', $useragent)) {
			$link = "http://www.networking.ibm.com/WebExplorer/";
			$title = "IBM " . detect_browser_version("WebExplorer", $useragent);
			$code = "ibmwebexplorer";
			...
			$title = detect_browser_version("Links", $useragent);
			$code = "links";
		} elseif (preg_match('/Lobo/i', $useragent)) {
			$link = "http://www.lobobrowser.org/";
			$title = detect_browser_version("Lobo", $useragent);
			$code = "lobo";
		} elseif (preg_match('/lolifox/i', $useragent)) {
			$link = "http://www.lolifox.com/";
			$title = detect_browser_version("lolifox", $useragent);
			$code = "lolifox";
			...
			$title = detect_browser_version("Multi-Browser", $useragent);
			$code = "multi-browserxp";
		} elseif (preg_match('/MultiZilla/i', $useragent)) {
			$link = "http://multizilla.mozdev.org/";
			$title = detect_browser_version("MultiZilla", $useragent);
			$code = "mozilla";
			...
			$title = detect_browser_version("Opera Labs", $useragent);
			$code = "opera-next";
		} elseif (preg_match('/Opera Next/i', $useragent)
			|| (preg_match('/Opera/i', $useragent)
				&& preg_match('/Edition Next/i', $useragent))) {
			$link = "http://www.opera.com/support/kb/view/991/";
			$title = detect_browser_version("Opera Next", $useragent);
			$code = "opera-next";
		} elseif (preg_match('/Opera/i', $useragent)) {
			$link = "http://www.opera.com/";
			$title = detect_browser_version("Opera", $useragent);
			$code = "opera-1";
			...
			if (preg_match('/(Edition Next)/i', $useragent)) {
				...
				$title = detect_browser_version("Opera Developer", $useragent);
			...
			$title = detect_browser_version("Orca", $useragent);
			$code = "orca";
		} elseif (preg_match('/Oregano/i', $useragent)) {
			$link = "http://en.wikipedia.org/wiki/Oregano_(web_browser)";
			$title = detect_browser_version("Oregano", $useragent);
			$code = "oregano";
			...
			$title = detect_browser_version("Phoenix", $useragent);
			$code = "phoenix";
			...
			$title = "QtWeb Internet " . detect_browser_version("Browser", $useragent);
			$code = "qtwebinternetbrowser";
		} elseif (preg_match('/QupZilla/i', $useragent)) {
			$link = "http://www.qupzilla.com/";
			$title = detect_browser_version("QupZilla", $useragent);
			$code = "qupzilla";
			...
			$title = detect_browser_version("Thunderbird", $useragent);
			$code = "thunderbird";
		} elseif (preg_match('/Tizen/i', $useragent)) {
			$link = "https://www.tizen.org/";
			$title = detect_browser_version("Tizen", $useragent);
			$code = "tizen";
		} elseif (preg_match('/Tjusig/i', $useragent)) {
			$link = "http://www.tjusig.cz/";
			$title = detect_browser_version("Tjusig", $useragent);
			$code = "tjusig";
		} elseif (preg_match('/TencentTraveler/i', $useragent)) {
			$link = "http://tt.qq.com/";
			$title = detect_browser_version("TencentTraveler", $useragent);
			$code = "tt-explorer";
		} elseif (preg_match('/UC?Browser/i', $useragent)) {
			$link = "http://www.uc.cn/";
			$title = detect_browser_version("UC?Browser", $useragent);
			$code = "ucbrowser";
			...
			$title = detect_browser_version("Vimprobable", $useragent);
			$code = "null";
		} elseif (preg_match('/Vonkeror/i', $useragent)) {
			$link = "http://zzo38computer.cjb.net/vonkeror/";
			$title = detect_browser_version("Vonkeror", $useragent);
			$code = "null";
			...
			$title = detect_browser_version("Android Webkit", $useragent);
			$code = "android-webkit";
		} elseif (preg_match('/WebianShell/i', $useragent)) {
			$link = "http://webian.org/shell/";
			$title = "Webian " . detect_browser_version("Shell", $useragent);
			$code = "webianshell";
			...
			$title = "Weltweitimnetz " . detect_browser_version("Browser", $useragent);
		...
		elseif (preg_match('/ABrowse/i', $useragent)) {
			...
			if (preg_match('/Windows NT 1.+Edge/i', $useragent)) {
				...
				$title = "Internet Explorer " . detect_browser_version("Spartan", $useragent);
				$code = "msie11";
			} else {
				$link = "http://google.com/chrome/";
				$title = "Google " . detect_browser_version("Chrome", $useragent);
				$code = "chrome";
			}
			...
			if (preg_match('/Version/i', $useragent)) {
				$title = detect_browser_version("Safari", $useragent);
			}
			...
			$link = "http://www.mozilla.org/";
			$title = detect_browser_version("Firefox", $useragent);
			$code = "firefox";
		} elseif (preg_match('/MSIE/i', $useragent) || preg_match('/Trident/i', $useragent)) {
			$link = "http://www.microsoft.com/windows/products/winfamily/ie/default.mspx";
			$title = "Internet Explorer" . detect_browser_version("MSIE", $useragent);
			...
			if (count($regmatch) > 0) {
				if ($regmatch[1] >= 11) {
					...
					// also ie8
					$code = "msie7";
					if (!isset($_SESSION['oldbrowser'])) {$_SESSION['oldbrowser'] = 1;}
				} elseif ($regmatch[1] >= 6) {
					$code = "msie6";
					if (!isset($_SESSION['oldbrowser'])) {$_SESSION['oldbrowser'] = 1;}
				} elseif ($regmatch[1] >= 4) {
...
$_SERVER['browser'] = $browser;

if (isset($_SESSION['oldbrowser']) && $_SESSION['oldbrowser'] == 1)
{
  // тут можно добавлять действия при определении устаревшего браузера у пользователя
	$_SESSION['oldbrowser'] = 0;
}
